package com.javabasicprojects.chessgame.gui;
...
import com.javabasicprojects.chessgame.gui.Table.MoveLog;
...
public class TakenPiecesPanel extends JPanel {
    ...
    public void redo(final MoveLog moveLog) {
        ...
        for (final Piece takenPiece : whiteTakenPieces) {
            try {
                final BufferedImage image = ImageIO.read(new File("icons/plain/" + takenPiece.getPieceAlliance().toString().substring(0, 1) + takenPiece.toString()));
