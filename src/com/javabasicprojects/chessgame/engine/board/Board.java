...
import com.javabasicprojects.chessgame.engine.pieces.*;
...
public class Board {
    ...
    private static Collection<Piece> calculateActivePieces(final Builder builder, final Alliance alliance) {
        return builder.boardConfig.values().stream().filter(piece -> piece.getPieceAlliance() == alliance).collect(Collectors.toList());
    }
    ...
    public static class Builder {
        ...
        public void setMoveTransition(Move transitionMove) {
